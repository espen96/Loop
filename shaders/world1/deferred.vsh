...
void main() {
	...
	gl_Position.xy = gl_Position.xy*vec2(18.+258*20,258.)*texelSize;
	...
	vec3 bouncedSun = 0.3 * vec3(0.9,0.5,0.2)/1500;
  ...
  t24(10, 18,		12, 20,		10, 20,		10, 12);
	...
	VFAmount = E_CLOUDY_FOG_AMOUNT*(fogAmount0*fogAmount0+FOG_RAIN_MULTIPLIER*1.8/20000.*rainStrength);
	fogAmount = E_BASE_FOG_AMOUNT*(fogAmount0+max(FOG_RAIN_MULTIPLIER*1/15.*rainStrength , FOG_TOD_MULTIPLIER*1/50.*clamp(modWT-13000.,0.,1000.0)/1000.*(1.0-clamp(modWT-23000.,0.,1000.0)/1000.)));
}
